...
#ifndef CornerApp_SWIFT_H
#define CornerApp_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CornerApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12CornerApp11AppDelegate")
...
SWIFT_CLASS("_TtC12CornerApp17MainFlutterWindow")
